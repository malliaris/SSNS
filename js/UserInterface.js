...
class UserInterface {
	...
	Params_HS.UICI_IC = new UICI_HS_IC(this, "UI_P_SM_HS_IC", ["grid", "\\mathrm{random \\; | \\; single} \\; \\mathbf{v}_0", "grid", "random", "grid"], "/static/images/SSNS/UICI/cycle_indicator_", ".svg", false);
