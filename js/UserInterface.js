...
class UserInterface {
	...
	Params_HS.UICI_rho = new UICI_IG(this, "UI_P_SM_HS_rho", ["\\small \\mathrm{single \\; value}", "\\small \\mathrm{distribution}"], "/static/images/SSNS/UICI/cycle_indicator_", ".svg", false);
	Params_HS.UICI_R = new UICI_IG(this, "UI_P_SM_HS_R", ["\\small \\mathrm{single \\; value}", "\\small \\mathrm{distribution}"], "/static/images/SSNS/UICI/cycle_indicator_", ".svg", false);
	...
	Params_LM.UICI_IC = new UICI_LM(this, "UI_P_ND_LM_IC", ["(3.44, 0.999999)", "(1.25, 0.9999)", "(4.0, 0.75001)", "(2.99, 0.51)", "(0.999, 0.5)"], "/static/images/SSNS/UICI/cycle_indicator_", ".svg", false);
