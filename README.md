...
* A handful of system types listed in the [abbreviations](#abbreviations-labels-etc) section are only at the concept stage, i.e., not yet implemented.  The focus in the early **SSNS** development stages was on having a small, diverse collection of systems implemented so that the evolution of the machinery of <samp>Trajectory</samp>, <samp>PlotType</samp>, etc. classes was directed but agile.
