...
* Once we believe the user is adequately protected from overuse of resources, we should ask whether anything interesting can be done with the amount computation that is allowed!
